									...
									<ul class="list-group list-unstyled list-group-flush">
										...
										<li>
											<a href="#" class="list-group-item-action border-0 border-bottom d-flex p-3">
												...
												<div>
													<p class="text-body small m-0">تقرير الحضور الشهري متاح الآن</p>
													<u class="small">منذ 30 دقيقة</u>
												</div>
											</a>
										</li>
									</ul>
									...
									<div>
										...
										<ul class="list-inline mb-0">
											<li class="list-inline-item me-3 mb-1 mb-sm-0">
												...
												<span class="text-body fw-light">التقارير المتاحة</span>
											</li>
											<li class="list-inline-item me-3 mb-1 mb-sm-0">
												<span class="h6">8</span>
												<span class="text-body fw-light">تقارير حديثة</span>
											</li>
											<li class="list-inline-item me-3 mb-1 mb-sm-0">
												<span class="h6">PDF</span>
												<span class="text-body fw-light">تصدير متاح</span>
											</li>
										</ul>
									</div>
									<!-- Button -->
									<div class="mt-2 mt-sm-0">
										<a href="#" class="btn btn-outline-primary mb-0">تصدير جميع التقارير</a>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="row">
					...
					<div class="col-xl-3">
						...
						<div class="list-group list-group-dark list-group-borderless collapse-list">
							...
							<a class="list-group-item active" href="student-reports.php"><i class="bi bi-file-earmark-text fa-fw me-2"></i>التقارير</a>
							<a class="list-group-item" href="student-profile.php"><i class="bi bi-person-circle fa-fw me-2"></i>الملف الشخصي</a>
							<a class="list-group-item" href="student-settings.php"><i class="bi bi-gear fa-fw me-2"></i>الإعدادات</a>
					...
					<div class="col-xl-9">
						...
						<!-- أنواع التقارير START -->
						<div class="row mb-4">
							<!-- تقارير الحضور -->
							<div class="col-md-6 col-lg-4 mb-3">
								<div class="card h-100">
									<div class="card-body text-center">
										<div class="icon-lg bg-primary bg-opacity-10 rounded-circle mx-auto mb-3">
											<i class="bi bi-calendar-check text-primary fs-4"></i>
										</div>
										<h5 class="mb-2">تقارير الحضور</h5>
										<p class="text-body small mb-3">تقارير شاملة عن الحضور والغياب</p>
										<a href="#" class="btn btn-primary btn-sm">عرض التقرير</a>
									</div>
								</div>
							</div>
							...
							<div class="col-md-6 col-lg-4 mb-3">
								<div class="card h-100">
									<div class="card-body text-center">
										<div class="icon-lg bg-success bg-opacity-10 rounded-circle mx-auto mb-3">
											<i class="bi bi-award text-success fs-4"></i>
										</div>
										<h5 class="mb-2">تقارير الدرجات</h5>
										<p class="text-body small mb-3">تقارير مفصلة للدرجات والتقديرات</p>
										<a href="#" class="btn btn-success btn-sm">عرض التقرير</a>
									</div>
								</div>
							</div>
							...
							<div class="col-md-6 col-lg-4 mb-3">
								<div class="card h-100">
									<div class="card-body text-center">
										<div class="icon-lg bg-warning bg-opacity-10 rounded-circle mx-auto mb-3">
											<i class="bi bi-file-text text-warning fs-4"></i>
										</div>
										<h5 class="mb-2">التقرير الشامل</h5>
										<p class="text-body small mb-3">تقرير شامل يتضمن جميع البيانات</p>
										<a href="#" class="btn btn-warning btn-sm">تحميل PDF</a>
									</div>
								</div>
							</div>
						</div>
								...
								<div class="table-responsive border-0">
									<table class="table table-hover align-middle mb-0">
										<thead class="table-light">
											<tr>
												<th scope="col" class="border-0 rounded-start">نوع التقرير</th>
												<th scope="col" class="border-0">الفترة</th>
												<th scope="col" class="border-0">تاريخ الإنشاء</th>
										...
										<tbody>
											<!-- تقرير حضور شهري -->
											<tr>
												<td class="fw-bold text-primary">تقرير الحضور الشهري</td>
												<td>سبتمبر 2025</td>
												<td>10 سبتمبر 2025</td>
												<td><span class="badge bg-success bg-opacity-10 text-success">جاهز</span></td>
												<td>
													<a href="#" class="btn btn-sm btn-primary"><i class="bi bi-eye me-1"></i>عرض</a>
													<a href="#" class="btn btn-sm btn-outline-primary ms-1"><i class="bi bi-download me-1"></i>تحميل</a>
												</td>
											</tr>
											
											<!-- تقرير درجات فصلي -->
											<tr>
												<td class="fw-bold text-success">تقرير الدرجات الفصلي</td>
											...
											<!-- تقرير أداء شامل -->
											<tr>
												<td class="fw-bold text-warning">تقرير الأداء الشامل</td>
												<td>أغسطس 2025</td>
												<td>05 سبتمبر 2025</td>
												<td><span class="badge bg-warning bg-opacity-10 text-warning">قيد المعالجة</span></td>
												<td>
													<a href="#" class="btn btn-sm btn-secondary disabled"><i class="bi bi-clock me-1"></i>انتظار</a>
												</td>
											</tr>
											
											<!-- تقرير حضور أسبوعي -->
											<tr>
												<td class="fw-bold text-info">تقرير الحضور الأسبوعي</td>
												<td>الأسبوع الأول - سبتمبر</td>
												<td>03 سبتمبر 2025</td>
												<td><span class="badge bg-success bg-opacity-10 text-success">جاهز</span></td>
												<td>
													<a href="#" class="btn btn-sm btn-primary"><i class="bi bi-eye me-1"></i>عرض</a>
													<a href="#" class="btn btn-sm btn-outline-primary ms-1"><i class="bi bi-download me-1"></i>تحميل</a>
											...
											<!-- تقرير تفصيلي للمواد -->
											<tr>
												<td class="fw-bold text-danger">تقرير تفصيلي للمواد</td>
												<td>جميع المواد - 2025</td>
						...
						<!-- التقارير المتاحة END -->

						<!-- إحصائيات التقارير START -->
						<div class="row mb-4">
							<!-- إجمالي التقارير -->
							<div class="col-sm-6 col-lg-4 mb-3 mb-lg-0">
								<div class="d-flex justify-content-center align-items-center p-4 bg-primary bg-opacity-15 rounded-3">
									<span class="display-6 lh-1 text-primary mb-0"><i class="bi bi-file-earmark-text fa-fw"></i></span>
									<div class="ms-4">
										<div class="d-flex">
											<h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="15" data-purecounter-delay="200">0</h5>
										</div>
										<p class="mb-0 h6 fw-light">إجمالي التقارير</p>
									</div>
								</div>
							</div>
							<!-- التقارير الجاهزة -->
							<div class="col-sm-6 col-lg-4 mb-3 mb-lg-0">
								<div class="d-flex justify-content-center align-items-center p-4 bg-success bg-opacity-15 rounded-3">
									<span class="display-6 lh-1 text-success mb-0"><i class="bi bi-check-circle fa-fw"></i></span>
									<div class="ms-4">
										<div class="d-flex">
											<h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="12" data-purecounter-delay="200">0</h5>
										</div>
										<p class="mb-0 h6 fw-light">تقارير جاهزة</p>
									</div>
								</div>
							</div>
							<!-- التقارير قيد المعالجة -->
							<div class="col-sm-6 col-lg-4 mb-3 mb-lg-0">
								<div class="d-flex justify-content-center align-items-center p-4 bg-warning bg-opacity-15 rounded-3">
									<span class="display-6 lh-1 text-warning mb-0"><i class="bi bi-clock fa-fw"></i></span>
									<div class="ms-4">
										<div class="d-flex">
											<h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="3" data-purecounter-delay="300">0</h5>
										</div>
										<p class="mb-0 h6 fw-light">قيد المعالجة</p>
									</div>
								</div>
							</div>
						</div>
						<!-- إحصائيات التقارير END -->

						<!-- طلب تقرير جديد START -->
						<div class="card bg-transparent border rounded-3">
							<div class="card-header bg-transparent border-bottom">
								<h3 class="mb-0">طلب تقرير جديد</h3>
							</div>
							<div class="card-body">
								<div class="row g-3">
									<!-- نوع التقرير -->
									<div class="col-md-6">
										<div class="alert alert-primary d-flex align-items-center" role="alert">
											...
											<div>
												<h6 class="mb-1">تقرير مخصص</h6>
												<p class="mb-0 small">اطلب تقرير مخصص حسب احتياجاتك</p>
												<a href="#" class="btn btn-primary btn-sm mt-2">طلب تقرير</a>
											</div>
										</div>
									</div>
									...
									<div class="col-md-6">
										<div class="alert alert-success d-flex align-items-center" role="alert">
											...
											<div>
												<h6 class="mb-1">تقرير سريع</h6>
												<p class="mb-0 small">احصل على تقرير سريع لآخر 30 يوم</p>
												<a href="#" class="btn btn-success btn-sm mt-2">إنشاء فوري</a>
											</div>
										</div>
									</div>
								</div>
