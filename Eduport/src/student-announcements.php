						...
						<div class="dropdown-menu dropdown-animation dropdown-menu-end dropdown-menu-size-md p-0 shadow-lg border-0">
							<div class="card bg-transparent">
								<div class="card-header bg-transparent border-bottom py-4 d-flex justify-content-between align-items-center">
									<h6 class="m-0">الإشعارات <span class="badge bg-danger bg-opacity-10 text-danger ms-2">3 جديد</span></h6>
									...
									<ul class="list-group list-unstyled list-group-flush">
										...
										<li>
											<a href="#" class="list-group-item-action border-0 border-bottom d-flex p-3">
												...
												<div>
													<p class="text-body small m-0">إعلان جديد من إدارة المدرسة</p>
										...
										<li>
											<a href="#" class="list-group-item-action border-0 border-bottom d-flex p-3">
												...
												<div>
													<p class="text-body small m-0">تذكير: موعد تسليم المشروع غداً</p>
													<span class="small">منذ ساعة</span>
												</div>
											</a>
										</li>
									</ul>
									...
									<div>
										...
										<ul class="list-inline mb-0">
											<li class="list-inline-item me-3 mb-1 mb-sm-0">
												...
												<span class="text-body fw-light">إجمالي الإعلانات</span>
											</li>
											<li class="list-inline-item me-3 mb-1 mb-sm-0">
												<span class="h6">6</span>
												<span class="text-body fw-light">إعلانات جديدة</span>
											</li>
											<li class="list-inline-item me-3 mb-1 mb-sm-0">
												<span class="h6">3</span>
												<span class="text-body fw-light">عاجل</span>
											</li>
										</ul>
									</div>
									<!-- Button -->
									<div class="mt-2 mt-sm-0">
										<a href="#" class="btn btn-outline-primary mb-0">تصدير الإعلانات</a>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="row">
					...
					<div class="col-xl-3">
						...
						<div class="list-group list-group-dark list-group-borderless collapse-list">
							...
							<a class="list-group-item" href="#"><i class="bi bi-journals fa-fw me-2"></i>الدروس المتاحة</a>
							...
							<a class="list-group-item active" href="student-announcements.php"><i class="bi bi-megaphone fa-fw me-2"></i>الإعلانات</a>
					...
					<div class="col-xl-9">
						...
						<div class="card bg-transparent border rounded-3 mb-4">
							<div class="card-header bg-transparent border-bottom">
								<h3 class="mb-0">الإعلانات والتنبيهات</h3>
							</div>
							<div class="card-body">
								<div class="row g-3">
									<!-- إعلان عاجل -->
									<div class="col-md-6">
										<div class="alert alert-danger d-flex align-items-center" role="alert">
											...
											<div>
												<h6 class="mb-1">تغيير موعد الامتحان - عاجل</h6>
												<p class="mb-0 small">تم تغيير موعد امتحان الرياضيات من الأحد إلى الثلاثاء</p>
									...
									<div class="col-md-6">
										<div class="alert alert-primary d-flex align-items-center" role="alert">
											...
											<div>
												<h6 class="mb-1">رفع دروس جديدة</h6>
												<p class="mb-0 small">تم رفع دروس جديدة في مواد الرياضيات والعلوم</p>
									...
									<div class="col-md-6">
										<div class="alert alert-info d-flex align-items-center" role="alert">
											...
											<div>
												<h6 class="mb-1">ورشة عمل</h6>
												<p class="mb-0 small">ورشة "مهارات الدراسة الفعالة" يوم الخميس القادم</p>
									...
									<div class="col-md-6">
										<div class="alert alert-warning d-flex align-items-center" role="alert">
											...
											<div>
												<h6 class="mb-1">تذكير المشروع</h6>
												<p class="mb-0 small">آخر موعد لتسليم مشروع العلوم هو الاثنين القادم</p>
									...
									<div class="col-md-6">
										<div class="alert alert-success d-flex align-items-center" role="alert">
											...
											<div>
												<h6 class="mb-1">تهنئة باليوم الوطني</h6>
												<p class="mb-0 small">أسمى التهاني بمناسبة اليوم الوطني السعودي الـ 95</p>
									...
									<div class="col-md-6">
										<div class="alert alert-secondary d-flex align-items-center" role="alert">
											...
											<div>
												<h6 class="mb-1">إرشادات الصحة والسلامة</h6>
												<p class="mb-0 small">اتباع إرشادات الصحة والسلامة داخل المدرسة</p>
						...
						<!-- إحصائيات الإعلانات START -->
						<div class="row mb-4">
							<!-- إجمالي الإعلانات -->
							<div class="col-sm-6 col-lg-4 mb-3 mb-lg-0">
								<div class="d-flex justify-content-center align-items-center p-4 bg-primary bg-opacity-15 rounded-3">
									<span class="display-6 lh-1 text-primary mb-0"><i class="bi bi-megaphone fa-fw"></i></span>
									<div class="ms-4">
										<div class="d-flex">
											<h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="18" data-purecounter-delay="200">0</h5>
										</div>
										<p class="mb-0 h6 fw-light">إجمالي الإعلانات</p>
									</div>
								</div>
							</div>
							<!-- إعلانات جديدة -->
							<div class="col-sm-6 col-lg-4 mb-3 mb-lg-0">
								<div class="d-flex justify-content-center align-items-center p-4 bg-success bg-opacity-15 rounded-3">
									<span class="display-6 lh-1 text-success mb-0"><i class="bi bi-bell fa-fw"></i></span>
									<div class="ms-4">
										<div class="d-flex">
											<h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="6" data-purecounter-delay="200">0</h5>
										</div>
										<p class="mb-0 h6 fw-light">إعلانات جديدة</p>
									</div>
								</div>
							</div>
							<!-- إعلانات عاجلة -->
							<div class="col-sm-6 col-lg-4 mb-3 mb-lg-0">
								<div class="d-flex justify-content-center align-items-center p-4 bg-danger bg-opacity-15 rounded-3">
									<span class="display-6 lh-1 text-danger mb-0"><i class="bi bi-exclamation-triangle fa-fw"></i></span>
									<div class="ms-4">
										<div class="d-flex">
											<h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="3" data-purecounter-delay="300">0</h5>
										</div>
										<p class="mb-0 h6 fw-light">إعلانات عاجلة</p>
									</div>
								</div>
							</div>
						</div>
						<!-- إحصائيات الإعلانات END -->

						<!-- أحدث الإعلانات START -->
						<div class="card bg-transparent border rounded-3">
							<div class="card-header bg-transparent border-bottom">
								<h3 class="mb-0">الإعلانات الحديثة</h3>
							</div>
							<div class="card-body">
								<div class="table-responsive border-0">
									<table class="table table-hover align-middle mb-0">
										<thead class="table-light">
											<tr>
												<th scope="col" class="border-0 rounded-start">النوع</th>
												<th scope="col" class="border-0">العنوان</th>
										...
										<tbody>
											<!-- إعلان عاجل -->
											<tr>
												<td><i class="bi bi-exclamation-triangle text-danger fs-5"></i></td>
												<td class="fw-bold">تغيير موعد الامتحان</td>
												<td>10 سبتمبر 2025</td>
												<td><span class="badge bg-danger bg-opacity-10 text-danger">عاجل</span></td>
											</tr>
											
											<!-- إعلان أكاديمي -->
											<tr>
												<td><i class="bi bi-book text-primary fs-5"></i></td>
												<td class="fw-bold">رفع دروس جديدة</td>
												<td>09 سبتمبر 2025</td>
												<td><span class="badge bg-primary bg-opacity-10 text-primary">أكاديمي</span></td>
											</tr>
											
											<!-- إعلان فعالية -->
											<tr>
												<td><i class="bi bi-calendar-event text-info fs-5"></i></td>
												<td class="fw-bold">ورشة مهارات الدراسة</td>
												<td>08 سبتمبر 2025</td>
												<td><span class="badge bg-info bg-opacity-10 text-info">فعالية</span></td>
											</tr>
											
											<!-- إعلان مشروع -->
											<tr>
												<td><i class="bi bi-clipboard-check text-warning fs-5"></i></td>
												<td class="fw-bold">تذكير تسليم المشروع</td>
												<td>07 سبتمبر 2025</td>
												<td><span class="badge bg-warning bg-opacity-10 text-warning">مشروع</span></td>
											</tr>
											
											<!-- إعلان عام -->
											<tr>
												<td><i class="bi bi-megaphone text-success fs-5"></i></td>
												<td class="fw-bold">تهنئة باليوم الوطني</td>
												<td>05 سبتمبر 2025</td>
												<td><span class="badge bg-success bg-opacity-10 text-success">عام</span></td>
											</tr>
										</tbody>
									</table>
								</div>
