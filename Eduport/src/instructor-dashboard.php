<?php
// تضمين ملف التكوين الجديد مع قاعدة البيانات
require_once 'api-config.php';

// تسجيل تشخيصي 
error_log("=== Instructor Dashboard Access Debug ===");
error_log("Session ID: " . session_id());
error_log("Session Data: " . print_r($_SESSION, true));
error_log("isLoggedIn(): " . (isLoggedIn() ? 'true' : 'false'));
error_log("hasRole('teacher'): " . (hasRole('teacher') ? 'true' : 'false'));

// التحقق من تسجيل الدخول مع رسائل مفصلة
if (!isLoggedIn()) {
    error_log("فشل: المدرس غير مسجل الدخول");
...
if (!hasRole('teacher')) {
    ...
    error_log("فشل: المستخدم لا يملك صلاحية مدرس. الدور الحالي: " . ($current_user['role'] ?? 'غير محدد'));
    header('Location: access-denied.php?reason=forbidden&required=teacher');
    exit;
}

// الحصول على بيانات لوحة المعلومات للمدرس
$dashboardData = getTeacherDashboardData();
$teacher_info = $dashboardData['teacher_info'];
...
$teacher_employee_id = $teacher_info['employee_id'];
$teacher_specialization = $teacher_info['specialization'];
$teacher_experience = $teacher_info['experience_years'];
...
<head>
	...
	<style>
		...
		/* Ensure circle containers remain circular and clip children */
		.rounded-circle { overflow: hidden !important; }

		/* Stat/feature small round icons */
		.icon-40 { 
			width: 40px; height: 40px; 
			display: inline-flex; align-items:center; justify-content:center; 
			line-height: 1; overflow: hidden; font-size: 18px;
		}

		/* Fix badge/icons inside cards not overflowing borders */
		.card .bi, .list-group .bi, .btn .bi { vertical-align: middle; }

		/* Prevent long labels from pushing icons */
									...
									<ul class="list-group list-unstyled list-group-flush">
										...
										<li>
											<a href="#" class="list-group-item-action border-0 border-bottom d-flex p-3">
												...
												<div>
													<p class="text-body small m-0">طالب جديد انضم إلى صفك</p>
										...
										<li>
											<a href="#" class="list-group-item-action border-0 border-bottom d-flex p-3">
												...
												<div>
													<p class="text-body small m-0">مطلوب تسليم تقرير الحضور</p>
													<span class="small">منذ 3 ساعات</span>
												</div>
											</a>
										</li>
									</ul>
							...
							<li class="px-3">
								<div class="d-flex align-items-center">
									...
									<div class="avatar me-3">
										<img id="js-profile-avatar" class="avatar-img rounded-circle shadow" src="assets/images/avatar/01.jpg" alt="avatar">
									</div>
									<div>
										<a id="js-profile-name" class="h6 mt-2 mt-sm-0" href="#"><?php echo htmlspecialchars($teacher_name); ?></a>
										<p id="js-profile-email" class="small m-0">teacher@example.com</p>
									</div>
								</div>
								<hr>
							</li>
						...
						<div class="card bg-transparent card-body p-0">
							<div class="row d-flex justify-content-between">
								...
								<div class="col d-md-flex justify-content-between align-items-center mt-4">
									<div>
										<h1 class="my-1 fs-4"><?php echo $teacher_name; ?> <i class="bi bi-patch-check-fill text-info small"></i></h1>
										<ul class="list-inline mb-0">
											<li class="list-inline-item h6 fw-light me-3 mb-1 mb-sm-0"><i class="fas fa-id-card text-primary me-2"></i>رقم الموظف: <?php echo $teacher_employee_id; ?></li>
											<li class="list-inline-item h6 fw-light me-3 mb-1 mb-sm-0"><i class="fas fa-user-graduate text-orange me-2"></i><?php echo $total_students; ?> طالب</li>
											<li class="list-inline-item h6 fw-light me-3 mb-1 mb-sm-0"><i class="fas fa-book text-purple me-2"></i><?php echo $total_subjects; ?> مادة</li>
											<li class="list-inline-item h6 fw-light me-3 mb-1 mb-sm-0"><i class="fas fa-graduation-cap text-success me-2"></i><?php echo $total_classes; ?> فصل</li>
										</ul>
									</div>
									<!-- Button -->
									<div class="d-flex align-items-center mt-2 mt-md-0">
										<a href="instructor-create-course.php" class="btn btn-success mb-0">إنشاء درس جديد</a>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="offcanvas-body p-3 p-xl-0">
								<div class="bg-dark border rounded-3 pb-0 p-3 w-100">
									...
									<div class="list-group list-group-dark list-group-borderless">
										...
										<a class="list-group-item menu-item" href="#" data-page="students"><i class="bi bi-people fa-fw me-2"></i>إدارة الطلاب</a>
										<a class="list-group-item menu-item" href="#" data-page="attendance"><i class="bi bi-calendar-check fa-fw me-2"></i>تسجيل الحضور</a>
										<a class="list-group-item menu-item" href="#" data-page="lessons"><i class="bi bi-journals fa-fw me-2"></i>رفع الدروس</a>
										<a class="list-group-item menu-item" href="#" data-page="grades"><i class="bi bi-award fa-fw me-2"></i>إدخال الدرجات</a>
...
Footer END -->
	...
	<script>
		...
		function loadContent(page) {
			...
			// Show loading
			mainContent.innerHTML = '<div class="text-center py-5"><div class="spinner-border text-primary" role="status"><span class="visually-hidden">جاري التحميل...</span></div></div>';
			
			// Load content
			fetch(`instructor-pages/${page}.php`)
				...
				.catch(error => {
					mainContent.innerHTML = '<div class="alert alert-danger">حدث خطأ في تحميل المحتوى</div>';
				});
		}
