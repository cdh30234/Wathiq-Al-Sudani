...
<body>
	...
	<!-- Header START -->
	<header class="navbar-light navbar-transparent navbar-sticky header-static">
		<!-- Logo Nav START -->
		<nav class="navbar navbar-expand-lg">
			<div class="container">
				...
				<div class="navbar-nav ms-2">
					<button class="btn btn-sm btn-primary mb-0">Get access</button>
				</div>
						...
						<div class="bg-info rounded-3 shadow p-3 p-sm-4 position-relative overflow-hidden">
							...
							<div class="row">
								<div class="col-md-8 mx-auto text-center py-4 position-relative">
									<!-- Title -->
									<h2 class="text-white">Need early access?</h2>
									<p class="text-white">How promotion excellent curiosity yet attempted happiness Gay prosperous impression had conviction For every delay death ask to style Me mean able</p>
									<!-- Form -->
									<form class="row align-items-center justify-content-center mt-3">
										<div class="col-lg-8">
											<div class="bg-body shadow rounded-pill p-2">
												<div class="input-group">
													<input class="form-control border-0 me-1" type="email" placeholder="Enter your email">
													<button type="button" class="btn btn-blue mb-0 rounded-pill">Request!</button>
												</div>
											</div>
										</div>
									</form>
		...
		<div class="container">
			<div class="row mx-auto">
				<div class="col-lg-6 mx-auto text-center my-5">
					<!-- logo -->
					<a class="me-0 mb-3 text-center" href="index.php">
						<img class="light-mode-item mx-auto h-40px" src="assets/images/logo.svg" alt="logo">
						<img class="dark-mode-item mx-auto h-40px" src="assets/images/logo-light.svg" alt="logo">
					</a>
					<p class="mt-3">Eduport education theme, built specifically for the education centers which is dedicated to teaching and involving learners.</p>
					<!-- Links -->
					<ul class="nav text-center text-sm-end justify-content-center justify-content-center text-primary-hover mt-3 mt-md-0">
						<li class="nav-item"><a class="nav-link text-body" href="#">About</a></li>
						<li class="nav-item"><a class="nav-link text-body" href="#">Terms</a></li>
						<li class="nav-item"><a class="nav-link text-body" href="#">Privacy</a></li>
						<li class="nav-item"><a class="nav-link text-body" href="#">Career</a></li>
						<li class="nav-item"><a class="nav-link text-body" href="#">Contact us</a></li>
						<li class="nav-item"><a class="nav-link text-body pe-0" href="#">Cookies</a></li>
					</ul>
					<!-- Social media button -->
					...
					<!-- Bottom footer link -->
					<div class="text-body text-primary-hover mt-3"> Copyrights ©2024 Eduport. Build by <a href="https://1.envato.market/stackbros-portfolio" target="_blank" class="text-body">StackBros</a></div>
				</div>
			</div>
		</div>
	</footer>
