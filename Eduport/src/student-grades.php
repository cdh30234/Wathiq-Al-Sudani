									...
									<ul class="list-group list-unstyled list-group-flush">
										...
										<li>
											<a href="#" class="list-group-item-action border-0 border-bottom d-flex p-3">
												...
												<div>
													<p class="text-body small m-0">تم رفع نتائج امتحان الرياضيات</p>
									...
									<div>
										...
										<ul class="list-inline mb-0">
											<li class="list-inline-item me-3 mb-1 mb-sm-0">
												<span class="h6">88%</span>
												<span class="text-body fw-light">المعدل العام</span>
											</li>
											<li class="list-inline-item me-3 mb-1 mb-sm-0">
												<span class="h6">7</span>
												<span class="text-body fw-light">إجمالي المواد</span>
											</li>
											<li class="list-inline-item me-3 mb-1 mb-sm-0">
												<span class="h6">5</span>
												<span class="text-body fw-light">مواد ممتازة</span>
											</li>
										</ul>
									</div>
									<!-- Button -->
									<div class="mt-2 mt-sm-0">
										<a href="#" class="btn btn-outline-primary mb-0">عرض التقارير</a>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="row">
					...
					<div class="col-xl-3">
						...
						<div class="list-group list-group-dark list-group-borderless collapse-list">
							...
							<a class="list-group-item active" href="student-grades.php"><i class="bi bi-award fa-fw me-2"></i>النتائج والدرجات</a>
						...
						<div class="row mb-4">
							...
							<div class="col-sm-6 col-lg-4 mb-3 mb-lg-0">
								<div class="d-flex justify-content-center align-items-center p-4 bg-success bg-opacity-15 rounded-3">
									<span class="display-6 lh-1 text-success mb-0"><i class="bi bi-award fa-fw"></i></span>
									<div class="ms-4">
										<div class="d-flex">
											<h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="88" data-purecounter-delay="200">0</h5>
											<span class="h5 mb-0">%</span>
										</div>
										<p class="mb-0 h6 fw-light">المعدل العام</p>
									</div>
								</div>
							</div>
							<!-- إجمالي المواد -->
							<div class="col-sm-6 col-lg-4 mb-3 mb-lg-0">
								<div class="d-flex justify-content-center align-items-center p-4 bg-primary bg-opacity-15 rounded-3">
									...
									<div class="ms-4">
										<div class="d-flex">
											<h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="7" data-purecounter-delay="200">0</h5>
										</div>
										<p class="mb-0 h6 fw-light">إجمالي المواد</p>
									</div>
								</div>
							</div>
							<!-- المواد الممتازة -->
							<div class="col-sm-6 col-lg-4 mb-3 mb-lg-0">
								<div class="d-flex justify-content-center align-items-center p-4 bg-warning bg-opacity-15 rounded-3">
									<span class="display-6 lh-1 text-warning mb-0"><i class="bi bi-trophy fa-fw"></i></span>
									<div class="ms-4">
										<div class="d-flex">
											<h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="5" data-purecounter-delay="300">0</h5>
										</div>
										<p class="mb-0 h6 fw-light">مواد ممتازة</p>
									</div>
								</div>
							</div>
						</div>
								...
								<div class="table-responsive border-0">
									<table class="table table-hover align-middle mb-0">
										<thead class="table-light">
											<tr>
												<th scope="col" class="border-0 rounded-start">المادة</th>
												<th scope="col" class="border-0">الامتحان النهائي</th>
												<th scope="col" class="border-0">أعمال السنة</th>
												<th scope="col" class="border-0">المجموع</th>
												<th scope="col" class="border-0 rounded-end">التقدير</th>
											</tr>
										</thead>
										...
										<tbody>
											...
											<!-- اللغة العربية -->
											<tr>
												<td class="text-success fw-bold">اللغة العربية</td>
												<td>46/50</td>
												<td>46/50</td>
											...
											<!-- اللغة الإنجليزية -->
											<tr>
												<td class="text-warning fw-bold">اللغة الإنجليزية</td>
												<td>45/50</td>
												<td>45/50</td>
											...
											<!-- العلوم -->
											<tr>
												<td class="text-info fw-bold">العلوم</td>
												<td>44/50</td>
												<td>44/50</td>
								...
								<div class="row g-3">
									...
									<div class="col-md-6">
										<div class="alert alert-success d-flex align-items-center" role="alert">
											...
											<div>
												<h6 class="mb-1">أعلى درجة</h6>
												<p class="mb-0 small">الرياضيات: 95% (ممتاز)</p>
											</div>
										</div>
									</div>
									...
									<div class="col-md-6">
										<div class="alert alert-warning d-flex align-items-center" role="alert">
											<i class="bi bi-arrow-down-circle-fill me-2 fs-4"></i>
											<div>
												<h6 class="mb-1">نقطة للتحسين</h6>
												<p class="mb-0 small">التربية الإسلامية: 80% (جيد جداً)</p>
											</div>
										</div>
									</div>
									...
									<div class="col-md-6">
										<div class="alert alert-primary d-flex align-items-center" role="alert">
											...
											<div>
												<h6 class="mb-1">التقدير العام</h6>
												<p class="mb-0 small">ممتاز - أداء متميز في معظم المواد</p>
											</div>
										</div>
									</div>
									...
									<div class="col-md-6">
										<div class="alert alert-info d-flex align-items-center" role="alert">
											...
											<div>
												<h6 class="mb-1">توصية</h6>
												<p class="mb-0 small">التركيز على التربية الإسلامية لتحسين الدرجة</p>
											</div>
										</div>
									</div>
								</div>
