									...
									<ul class="list-group list-unstyled list-group-flush">
										...
										<li>
											<a href="#" class="list-group-item-action border-0 border-bottom d-flex p-3">
												...
												<div>
													<p class="text-body small m-0">درس جديد متاح في العلوم</p>
									...
									<div>
										...
										<ul class="list-inline mb-0">
											<li class="list-inline-item me-3 mb-1 mb-sm-0">
												...
												<span class="text-body fw-light">دروس متاحة</span>
											</li>
											<li class="list-inline-item me-3 mb-1 mb-sm-0">
											...
											<li class="list-inline-item me-3 mb-1 mb-sm-0">
												...
												<span class="text-body fw-light">مواد</span>
											</li>
										</ul>
									</div>
									<!-- Button -->
									<div class="mt-2 mt-sm-0">
										<a href="#" class="btn btn-outline-primary mb-0">تحميل جميع الدروس</a>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="row">
					...
					<div class="col-xl-3">
						...
						<div class="list-group list-group-dark list-group-borderless collapse-list">
							...
							<a class="list-group-item active" href="student-lessons.php"><i class="bi bi-journals fa-fw me-2"></i>الدروس المتاحة</a>
					...
					<div class="col-xl-9">
						...
						<div class="row mb-4">
							...
							<div class="col-sm-6 col-lg-4 mb-3 mb-lg-0">
								<div class="d-flex justify-content-center align-items-center p-4 bg-primary bg-opacity-15 rounded-3">
									<span class="display-6 lh-1 text-primary mb-0"><i class="bi bi-journals fa-fw"></i></span>
									<div class="ms-4">
										<div class="d-flex">
											<h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="45" data-purecounter-delay="200">0</h5>
										</div>
										<p class="mb-0 h6 fw-light">دروس متاحة</p>
									</div>
								</div>
							</div>
							<!-- الدروس المكتملة -->
							<div class="col-sm-6 col-lg-4 mb-3 mb-lg-0">
								<div class="d-flex justify-content-center align-items-center p-4 bg-success bg-opacity-15 rounded-3">
									...
									<div class="ms-4">
										...
										<p class="mb-0 h6 fw-light">دروس مكتملة</p>
									</div>
								</div>
							</div>
							<!-- نسبة الإنجاز -->
							<div class="col-sm-6 col-lg-4 mb-3 mb-lg-0">
								<div class="d-flex justify-content-center align-items-center p-4 bg-warning bg-opacity-15 rounded-3">
									<span class="display-6 lh-1 text-warning mb-0"><i class="bi bi-percent fa-fw"></i></span>
									<div class="ms-4">
										<div class="d-flex">
											<h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="56" data-purecounter-delay="300">0</h5>
											<span class="h5 mb-0">%</span>
										</div>
										<p class="mb-0 h6 fw-light">نسبة الإنجاز</p>
									</div>
								</div>
							</div>
						</div>
									...
									<table class="table table-hover align-middle mb-0">
										<thead class="table-light">
											<tr>
												...
												<th scope="col" class="border-0">عنوان الدرس</th>
												<th scope="col" class="border-0">تاريخ الرفع</th>
										...
										<tbody>
											...
											<tr>
												...
												<td>الدوال الخطية والتربيعية</td>
												<td>10 سبتمبر 2025</td>
												<td><span class="badge bg-success bg-opacity-10 text-success">مكتمل</span></td>
												<td>
											...
											<tr>
												...
												<td>قوانين نيوتن للحركة</td>
												<td>09 سبتمبر 2025</td>
												<td><span class="badge bg-warning bg-opacity-10 text-warning">جاري الدراسة</span></td>
												<td>
													<a href="#" class="btn btn-sm btn-primary"><i class="bi bi-eye me-1"></i>عرض</a>
													<a href="#" class="btn btn-sm btn-outline-primary ms-1"><i class="bi bi-download me-1"></i>تحميل</a>
												</td>
											...
											<tr>
												...
												<td>التفاعلات الكيميائية</td>
												<td>08 سبتمبر 2025</td>
												<td><span class="badge bg-primary bg-opacity-10 text-primary">جديد</span></td>
												<td>
													<a href="#" class="btn btn-sm btn-primary"><i class="bi bi-eye me-1"></i>عرض</a>
													<a href="#" class="btn btn-sm btn-outline-primary ms-1"><i class="bi bi-download me-1"></i>تحميل</a>
												</td>
											...
											<tr>
												...
												<td>الحضارة الإسلامية</td>
												<td>06 سبتمبر 2025</td>
												<td><span class="badge bg-warning bg-opacity-10 text-warning">جاري الدراسة</span></td>
												<td>
													<a href="#" class="btn btn-sm btn-primary"><i class="bi bi-eye me-1"></i>عرض</a>
													<a href="#" class="btn btn-sm btn-outline-primary ms-1"><i class="bi bi-download me-1"></i>تحميل</a>
											...
											<!-- درس الجغرافيا -->
											<tr>
												<td class="text-secondary fw-bold">الجغرافيا</td>
												<td>المناخ والطقس</td>
											...
											<tr>
												<td class="text-dark fw-bold">التربية الإسلامية</td>
												<td>أركان الإسلام</td>
												<td>04 سبتمبر 2025</td>
												<td><span class="badge bg-success bg-opacity-10 text-success">مكتمل</span></td>
												<td>
													<a href="#" class="btn btn-sm btn-primary"><i class="bi bi-eye me-1"></i>عرض</a>
													<a href="#" class="btn btn-sm btn-outline-primary ms-1"><i class="bi bi-download me-1"></i>تحميل</a>
						...
						<!-- الدروس حسب المادة START -->
						<div class="card bg-transparent border rounded-3">
							<div class="card-header bg-transparent border-bottom">
								<h3 class="mb-0">الدروس حسب المادة</h3>
							</div>
							<div class="card-body">
								<div class="row g-3">
									<!-- مادة الرياضيات -->
									<div class="col-md-6">
										<div class="alert alert-primary d-flex align-items-center" role="alert">
											...
											<div>
												...
												<p class="mb-0 small">8 دروس متاحة | 5 مكتملة</p>
									...
									<div class="col-md-6">
										<div class="alert alert-success d-flex align-items-center" role="alert">
											<i class="bi bi-flask-fill me-2 fs-4"></i>
											<div>
												<h6 class="mb-1">العلوم</h6>
												<p class="mb-0 small">6 دروس متاحة | 4 مكتملة</p>
												<div class="progress mt-2" style="height: 4px;">
									...
									<div class="col-md-6">
										<div class="alert alert-warning d-flex align-items-center" role="alert">
											...
											<div>
												...
												<p class="mb-0 small">7 دروس متاحة | 3 مكتملة</p>
												<div class="progress mt-2" style="height: 4px;">
									...
									<div class="col-md-6">
										<div class="alert alert-info d-flex align-items-center" role="alert">
											...
											<div>
												<h6 class="mb-1">اللغة الإنجليزية</h6>
												<p class="mb-0 small">6 دروس متاحة | 4 مكتملة</p>
												<div class="progress mt-2" style="height: 4px;">
