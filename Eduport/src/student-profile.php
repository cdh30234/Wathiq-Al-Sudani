									...
									<ul class="list-group list-unstyled list-group-flush">
										...
										<li>
											<a href="#" class="list-group-item-action border-0 border-bottom d-flex p-3">
												...
												<div>
													<p class="text-body small m-0">تم تحديث بياناتك الشخصية بنجاح</p>
									...
									<div>
										...
										<ul class="list-inline mb-0">
											<li class="list-inline-item me-3 mb-1 mb-sm-0">
												<span class="h6">العاشر أ</span>
												<span class="text-body fw-light">الصف الدراسي</span>
											</li>
											<li class="list-inline-item me-3 mb-1 mb-sm-0">
												<span class="h6">2023001</span>
												<span class="text-body fw-light">رقم الطالب</span>
											</li>
											<li class="list-inline-item me-3 mb-1 mb-sm-0">
												<span class="h6">نشط</span>
												<span class="text-body fw-light">حالة الحساب</span>
											</li>
										</ul>
									</div>
									<!-- Button -->
									<div class="mt-2 mt-sm-0">
										<a href="#" class="btn btn-outline-primary mb-0">تعديل الملف</a>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="row">
					...
					<div class="col-xl-3">
						...
						<div class="list-group list-group-dark list-group-borderless collapse-list">
							...
							<a class="list-group-item active" href="student-profile.php"><i class="bi bi-person-circle fa-fw me-2"></i>الملف الشخصي</a>
					...
					<div class="col-xl-9">
						...
						<div class="card bg-transparent border rounded-3 mb-4">
							<div class="card-header bg-transparent border-bottom">
								<h3 class="mb-0">المعلومات الشخصية</h3>
							</div>
							<div class="card-body">
								<form>
									<div class="row g-3">
										...
										<div class="col-md-6">
											...
											<input type="text" class="form-control" value="محمد" readonly>
										</div>
										<!-- رقم الطالب -->
										<div class="col-md-6">
										...
										<div class="col-md-6">
											...
											<input type="email" class="form-control" value="ahmed.mohammed@school.edu.sa" readonly>
										</div>
										<!-- رقم الجوال -->
										<div class="col-md-6">
										...
										<div class="col-md-6">
											...
											<input type="date" class="form-control" value="2005-03-15" readonly>
										</div>
										<!-- الصف الدراسي -->
										<div class="col-md-6">
											<label class="form-label">الصف الدراسي</label>
											<input type="text" class="form-control" value="العاشر أ" readonly>
										</div>
										<!-- السنة الدراسية -->
										<div class="col-md-6">
										...
										<div class="col-12">
											...
											<textarea class="form-control" rows="3">الرياض، حي النخيل، شارع الملك فهد، المملكة العربية السعودية</textarea>
										</div>
										<!-- أزرار الحفظ -->
										<div class="col-12">
							...
							<div class="card-body">
								<div class="row g-3">
									...
									<div class="col-md-6">
										...
										<input type="tel" class="form-control" value="+966501234000" readonly>
									</div>
									<!-- البريد الإلكتروني -->
									<div class="col-md-6">
										<label class="form-label">البريد الإلكتروني</label>
										<input type="email" class="form-control" value="mohammed.ahmed@email.com" readonly>
									</div>
								</div>
							</div>
						</div>
						<!-- معلومات ولي الأمر END -->

						<!-- الأداء الأكاديمي START -->
						<div class="row mb-4">
							<!-- المعدل العام -->
							...
							<div class="col-sm-6 col-lg-4 mb-3 mb-lg-0">
								<div class="d-flex justify-content-center align-items-center p-4 bg-primary bg-opacity-15 rounded-3">
									<span class="display-6 lh-1 text-primary mb-0"><i class="bi bi-calendar-check fa-fw"></i></span>
									<div class="ms-4">
										<div class="d-flex">
							...
							<div class="col-sm-6 col-lg-4 mb-3 mb-lg-0">
								<div class="d-flex justify-content-center align-items-center p-4 bg-warning bg-opacity-15 rounded-3">
									<span class="display-6 lh-1 text-warning mb-0"><i class="bi bi-journals fa-fw"></i></span>
									<div class="ms-4">
										<div class="d-flex">
											<h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="7" data-purecounter-delay="300">0</h5>
										</div>
										<p class="mb-0 h6 fw-light">المواد المسجلة</p>
									</div>
								</div>
							</div>
						</div>
						<!-- الأداء الأكاديمي END -->

						<!-- تغيير كلمة المرور START -->
									...
									<div class="row g-3">
										...
										<div class="col-12">
											<div class="alert alert-info">
												<h6 class="mb-2">معايير كلمة المرور:</h6>
												<ul class="mb-0 small">
