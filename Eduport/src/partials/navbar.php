	...
	<header class="navbar-light navbar-sticky">
		...
		<nav class="navbar navbar-expand-xl z-index-9">
			<div class="container">
				...
				<!-- Guest actions START -->
				<div class="d-flex align-items-center js-auth-when-logged-out" style="display:none;">
					<a href="sign-in.php" class="btn btn-sm btn-outline-primary me-2">Sign In</a>
					<a href="sign-up.php" class="btn btn-sm btn-primary">Sign Up</a>
				</div>
				<!-- Guest actions END -->

				<!-- Profile START -->
				<div class="dropdown ms-1 ms-lg-0 js-auth-when-logged-in" style="display:none;">
					...
					<ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3" aria-labelledby="profileDropdown">
						...
						<li><a class="dropdown-item bg-danger-soft-hover js-logout" href="#"><i class="bi bi-power fa-fw me-2"></i>Sign Out</a></li>
						<li>
							<hr class="dropdown-divider">
						</li>
