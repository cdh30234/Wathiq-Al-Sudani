								...
								<div class="card shadow h-100">
									...
									<div class="card-body px-3">
										...
										<h5 class="card-title mb-0">
											<a href="shop-product-detail.php" class="stretched-link">HTML and CSS: Design and Build Websites (Paperback)</a>
										</h5>
									</div>
							...
							<div class="col-sm-6 col-lg-4 col-xl-3">
								<div class="card shadow h-100">
									...
									<div class="card-body px-3">
										<!-- Title -->
										<h5 class="card-title mb-0">
											<a href="shop-product-detail.php" class="stretched-link">Angular 4 Tutorial in audio (Compact Disk)</a>
										</h5>
									</div>
							...
							<div class="col-sm-6 col-lg-4 col-xl-3">
								<div class="card shadow h-100">
									...
									<div class="card-body px-3">
										<!-- Title -->
										<h5 class="card-title mb-0">
											<a href="shop-product-detail.php" class="stretched-link">Javascript: The Definitive Guide (PDF Book)</a>
										</h5>
									</div>
							...
							<div class="col-sm-6 col-lg-4 col-xl-3">
								<div class="card shadow h-100">
									...
									<div class="card-body px-3">
										<!-- Title -->
										<h5 class="card-title mb-0 ">
											<a href="shop-product-detail.php" class="stretched-link">The Principles of Beautiful Graphics Design (Paperback)</a>
										</h5>
									</div>
							...
							<div class="col-sm-6 col-lg-4 col-xl-3">
								<div class="card shadow h-100">
									...
									<div class="card-body px-3">
										<!-- Title -->
										<h5 class="card-title mb-0">
											<a href="shop-product-detail.php" class="stretched-link">Responsive Web Design (Paperback)</a>
										</h5>
									</div>
								...
								<div class="card shadow h-100">
									...
									<div class="card-body px-3">
										...
										<h5 class="card-title ,b-0">
											<a href="shop-product-detail.php" class="stretched-link">Learning Python, Fourth Edition (PDF Book)</a>
										</h5>
									</div>
							...
							<div class="col-sm-6 col-lg-4 col-xl-3">
								<div class="card shadow h-100">
									...
									<div class="card-body px-3">
										<!-- Title -->
										<h5 class="card-title mb-0">
											<a href="shop-product-detail.php" class="stretched-link">Perfect Genius Worksheets for Class 5 (Paperback)</a>
										</h5>
									</div>
							...
							<div class="col-sm-6 col-lg-4 col-xl-3">
								<div class="card shadow h-100">
									...
									<div class="card-body px-3">
										<!-- Title -->
										<h5 class="card-title mb-0">
											<a href="shop-product-detail.php" class="stretched-link">HTML and CSS: Design and Build Websites (Compact Disk)</a>
										</h5>
									</div>
