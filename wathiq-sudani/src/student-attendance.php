				...
				<div class="row">
					...
					<div class="col-xl-3">
						...
						<div class="list-group list-group-dark list-group-borderless collapse-list">
							...
							<a class="list-group-item active" href="student-attendance.php"><i class="bi bi-calendar-check fa-fw me-2"></i>الحضور والغياب</a>
					...
					<div class="col-xl-9">
						...
						<div class="row mb-4">
							...
							<div class="col-sm-6 col-lg-4 mb-3 mb-lg-0">
								<div class="d-flex justify-content-center align-items-center p-4 bg-success bg-opacity-15 rounded-3">
									<span class="display-6 lh-1 text-success mb-0"><i class="bi bi-calendar-check fa-fw"></i></span>
									<div class="ms-4">
										<div class="d-flex">
											<h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="68" data-purecounter-delay="200">0</h5>
										</div>
										<p class="mb-0 h6 fw-light">أيام حضور</p>
									</div>
								</div>
							</div>
							<!-- نسبة الحضور -->
							<div class="col-sm-6 col-lg-4 mb-3 mb-lg-0">
								<div class="d-flex justify-content-center align-items-center p-4 bg-primary bg-opacity-15 rounded-3">
									<span class="display-6 lh-1 text-primary mb-0"><i class="bi bi-percent fa-fw"></i></span>
									<div class="ms-4">
										<div class="d-flex">
											<h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="85" data-purecounter-delay="200">0</h5>
											<span class="h5 mb-0">%</span>
										</div>
										<p class="mb-0 h6 fw-light">نسبة الحضور</p>
									</div>
								</div>
							</div>
							<!-- أيام الغياب -->
							<div class="col-sm-6 col-lg-4 mb-3 mb-lg-0">
								<div class="d-flex justify-content-center align-items-center p-4 bg-danger bg-opacity-15 rounded-3">
									<span class="display-6 lh-1 text-danger mb-0"><i class="bi bi-calendar-x fa-fw"></i></span>
									<div class="ms-4">
										<div class="d-flex">
											<h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="12" data-purecounter-delay="300">0</h5>
										</div>
										<p class="mb-0 h6 fw-light">أيام غياب</p>
									</div>
								</div>
							</div>
						</div>
								...
								<div class="table-responsive border-0">
									<table class="table table-hover align-middle mb-0">
										<thead class="table-light">
											<tr>
												<th scope="col" class="border-0 rounded-start">التاريخ</th>
												<th scope="col" class="border-0">اليوم</th>
												<th scope="col" class="border-0">المادة</th>
												<th scope="col" class="border-0">وقت الوصول</th>
										...
										<tbody>
											<!-- سجل حضور -->
											<tr>
												<td class="text-primary fw-bold">10 سبتمبر 2025</td>
												<td>الأربعاء</td>
												<td>الرياضيات</td>
												<td>08:00 ص</td>
												<td><span class="badge bg-success bg-opacity-10 text-success">حاضر</span></td>
											</tr>
											
											<!-- سجل تأخير -->
											<tr>
												<td class="text-primary fw-bold">09 سبتمبر 2025</td>
												<td>الثلاثاء</td>
												<td>اللغة العربية</td>
												<td>08:15 ص</td>
											...
											<!-- سجل حضور -->
											<tr>
												<td class="text-primary fw-bold">08 سبتمبر 2025</td>
												<td>الإثنين</td>
											...
											<!-- سجل غياب -->
											<tr>
												<td class="text-primary fw-bold">07 سبتمبر 2025</td>
												<td>الأحد</td>
												<td>العلوم</td>
												<td>-</td>
												<td><span class="badge bg-danger bg-opacity-10 text-danger">غائب</span></td>
											</tr>
											
											<!-- سجل حضور -->
											<tr>
												<td class="text-primary fw-bold">05 سبتمبر 2025</td>
												<td>الخميس</td>
												<td>الرياضيات</td>
												<td>08:00 ص</td>
												<td><span class="badge bg-success bg-opacity-10 text-success">حاضر</span></td>
						...
						<!-- سجل الحضور والغياب END -->

						<!-- التفاصيل الإضافية START -->
						<div class="card bg-transparent border rounded-3">
							<div class="card-header bg-transparent border-bottom">
								<h3 class="mb-0">ملخص الحضور الشهري</h3>
							</div>
							<div class="card-body">
								<div class="row g-3">
									<!-- ملخص سبتمبر -->
									<div class="col-md-6">
										<div class="alert alert-primary d-flex align-items-center" role="alert">
											<i class="bi bi-calendar-month-fill me-2 fs-4"></i>
											<div>
												<h6 class="mb-1">سبتمبر 2025</h6>
												<p class="mb-0 small">نسبة الحضور: 85% | أيام حضور: 17 | أيام غياب: 3</p>
											</div>
										</div>
									</div>
									...
									<div class="col-md-6">
										<div class="alert alert-success d-flex align-items-center" role="alert">
											<i class="bi bi-calendar-month-fill me-2 fs-4"></i>
											<div>
												<h6 class="mb-1">أغسطس 2025</h6>
												<p class="mb-0 small">نسبة الحضور: 92% | أيام حضور: 23 | أيام غياب: 2</p>
											</div>
										</div>
									</div>
									...
									<div class="col-md-6">
										<div class="alert alert-warning d-flex align-items-center" role="alert">
											<i class="bi bi-calendar-month-fill me-2 fs-4"></i>
											<div>
												<h6 class="mb-1">يوليو 2025</h6>
												<p class="mb-0 small">نسبة الحضور: 78% | أيام حضور: 18 | أيام غياب: 5</p>
											</div>
										</div>
									</div>
									...
									<div class="col-md-6">
										<div class="alert alert-info d-flex align-items-center" role="alert">
											<i class="bi bi-calendar-month-fill me-2 fs-4"></i>
											<div>
												<h6 class="mb-1">يونيو 2025</h6>
												<p class="mb-0 small">نسبة الحضور: 88% | أيام حضور: 21 | أيام غياب: 3</p>
											</div>
										</div>
									</div>
								</div>
